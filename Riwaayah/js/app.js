...
async function loadProducts() {
  try {
    // Show fast skeleton loading
    container.innerHTML = Array(6).fill(`
      <div class="skeleton fast-skeleton" style="height: 380px; border-radius: 16px;">
        <div style="height: 280px; background: linear-gradient(90deg, #f3f4f6 25%, #e5e7eb 50%, #f3f4f6 75%); background-size: 200% 100%; animation: shimmer 0.8s infinite;"></div>
        <div style="padding: 20px;">
          <div style="height: 20px; width: 70%; background: linear-gradient(90deg, #f3f4f6 25%, #e5e7eb 50%, #f3f4f6 75%); background-size: 200% 100%; animation: shimmer 0.8s infinite; margin-bottom: 12px;"></div>
          <div style="height: 20px; width: 40%; background: linear-gradient(90deg, #f3f4f6 25%, #e5e7eb 50%, #f3f4f6 75%); background-size: 200% 100%; animation: shimmer 0.8s infinite;"></div>
        </div>
      </div>
    `).join('');
...
function renderProducts() {
  ...
  filteredProducts.forEach(product => {
    ...
    wishlistBtn.style.cssText = 'position: absolute; top: 12px; right: 12px; background: white; border: none; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; cursor: pointer; box-shadow: 0 2px 8px rgba(0,0,0,0.1); transition: all 0.2s; z-index: 2;';
