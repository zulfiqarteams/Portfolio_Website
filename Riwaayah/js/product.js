      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start;">
        ...
        <div style="padding-top: 8px;">
          ...
          <div style="display: flex; gap: 12px; margin-bottom: 20px;">
            ...
            <button id="wishlistBtn" class="btn" style="width: 56px; height: 56px; padding: 0; background: ${inWishlist ? '#ef4444' : '#f3f4f6'}; color: ${inWishlist ? 'white' : '#374151'}; border-radius: 12px;">
