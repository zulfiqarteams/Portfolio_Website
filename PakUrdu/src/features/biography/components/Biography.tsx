    ...
    {tab==='type' && <Card className="mt-6 overflow-hidden">
      <CardHeader>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <CardTitle>Type this chapter</CardTitle>
